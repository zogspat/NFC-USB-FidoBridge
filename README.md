...
It is very difficult to have a generalised solution that works with all FIDO 2 capable sites, even within these hardware and browser constraints. This implementation works with sites such as eBay, Google and Github, but doesn't for Yubico's demo.
